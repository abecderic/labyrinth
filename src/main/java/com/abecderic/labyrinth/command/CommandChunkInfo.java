    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        if (sender instanceof EntityPlayerMP)
        {
            ...
            if (player.dimension == Config.getConfig().dimId)
            {
                ...
                player.sendMessage(new TextComponentTranslation("command.chunkinfo", x + "", z + ""));
                ...
                player.sendMessage(new TextComponentTranslation("command.chunkinfo.name", chunk.getName()));
                player.sendMessage(new TextComponentTranslation("command.chunkinfo.walls", chunk.getNorth().toString().toLowerCase(), chunk.getWest().toString().toLowerCase(), chunkEast.getWest().toString().toLowerCase(), chunkSouth.getNorth().toString().toLowerCase()));
                player.sendMessage(new TextComponentTranslation("command.chunkinfo.size", chunk.getSize().toString()));
            }
            else
            {
